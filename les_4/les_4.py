...
print('43. Найти произведение пар чисел в списке. Парой считаем первый и последний элемент, второй и предпоследний и т.д.')
...
print('50. Вычислить число π c заданной точностью d')
print('51. Составить список простых множителей натурального числа N')
input_num = int(input('Введите номер задачи для проверки: '))


if input_num == 41:  # Определить, позицию второго вхождения строки в списке либо сообщить, что его нет
...
if input_num == 42:  # Найти сумму чисел списка стоящих на нечетной позиции
...
if input_num == 43:  # Найти произведение пар чисел в списке. Парой считаем первый и последний элемент, второй и предпоследний и т.д.
    n = int(input('Введите длину списка. Список сгенерируется случайными числами [-10, 10]: '))
    numbers = [random.randint(-10, 10) for i in range(0, n)]
    print(f'Начальный список: {numbers}')
    last = len(numbers) - 1
...
if input_num == 44:  # В заданном списке вещественных чисел найдите разницу между максимальным и минимальным значением дробной части элементов
...
if input_num == 45:  # Написать программу преобразования десятичного числа в двоичное
    n = int(input('N = '))
    x = n
    result = ''
    while x >= 1:
...
if input_num == 46:  # Дано число. Составить список чисел Фибоначчи, в том числе для отрицательных индексов
    n = int(input('N = '))
    fibonacci = []
    for i in range(0, n):
        if i == 0 :
...
if input_num == 47:  # Строка содержит набор чисел. Показать большее и меньшее число
...
if input_num == 48:  # Найти корни квадратного уравнения Ax² + Bx + C = 0
    a = int(input('A = '))
    b = int(input('B = '))
    c = int(input('C = '))
    d = b**2-4*a*c
...
if input_num == 49:  # Найти НОК двух чисел
    a = int(input('A = '))
    b = int(input('B = '))
    print(f'НОК = {round(a * b / nod(a, b))}')


if input_num == 50:  # Вычислить число π c заданной точностью d
    d = int(input('D = '))
    print(f'pi = {round(bbp(d), d)}')


if input_num == 51:  # Составить список простых множителей натурального числа N
    n = int(input('N = '))
    div = 2
    list = [1]
    while n > 1:
